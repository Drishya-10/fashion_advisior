...
Original file is located at
    https://colab.research.google.com/drive/1wvvHxlg2R5fKurlN6JtozwPfSJU0kxwF
"""
...
vectors   = np.load(os.path.join(BASE, "embedding_vectors.npy"))
ids       = np.load(os.path.join(BASE, "embedding_ids.npy"))
ids       = ids.astype(int)
